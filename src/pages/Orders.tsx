  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-2xl min-h-screen">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
        <h1 className="text-4xl font-bold gradient-text mb-2">{t('orders.title')}</h1>
        <p className="text-muted-foreground text-lg mb-8">Track and manage your orders</p>
              ...
              >
                <div className="p-6">
                  <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-5">
                    ...
                    <span className={`inline-flex items-center gap-1.5 shrink-0 px-3 py-1.5 rounded-full text-sm font-medium border ${config.badgeClass}`}>
